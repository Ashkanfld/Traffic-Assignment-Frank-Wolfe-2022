...
def main():
    for i in range(0,nCycle):
        if i==0:
            ...
            reportTotalCost('C://Users/SADID/Desktop/Traffic-Assignment-Frank-Wolfe-2022-main/Traffic-Assignment-Frank-Wolfe-2022-main/CSV_networks/Anaheim/TotalCost.csv',RG,totalCost,i)
        else:
            linkTimeCalculator(linkFlow, linkTime, a0Array, a1Array,node_number)
            timeGraph=timeGraphGenerator(networkArray,linkTime)
            ...
            if RG>=0 and RG<relativeGapAccuracy:
                break
    reportFlow('C://Users/SADID/Desktop/Traffic-Assignment-Frank-Wolfe-2022-main/Traffic-Assignment-Frank-Wolfe-2022-main/CSV_networks/Anaheim/Flow.csv',node_number,networkArray,linkFlow,linkTime)   
main()
